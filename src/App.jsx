...
import { fetchOverview, fetchUserRepos, fetchEvents, fetchUserProfile } from "./services/api.js";
import "./App.css";
...
function App() {
  ...
  const loadDashboardData = useCallback(async (userToFetch = currentUser) => {
    setLoading(true);
    setError(null);
    try {
        ...
        <nav className="main-nav-bar">
          ...
          >
            ...
            {repositories.length > 0 && (
              <span className="tab-pill">{repositories.length}</span>
            )}
          </button>
          ...
          >
            ...
            {selectedRepo && (
              <span className="tab-pill tab-pill-repo">{selectedRepo}</span>
            )}
          </button>
